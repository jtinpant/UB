...
async def register_raid(client):
    ...
    """
    # Identify the user owning this specific bot session immediately
    ...
    async def raid(e):
        # Permission: Global Owner/Sudo OR the User who is hosting this ID
